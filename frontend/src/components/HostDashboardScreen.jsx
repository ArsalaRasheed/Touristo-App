    ...
    <div className="min-h-screen bg-[color:var(--bg-primary)] p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-[color:var(--surface-primary)] p-4 rounded-xl shadow text-center border border-[color:var(--border-primary)]">
          <p className="text-2xl font-bold text-[color:var(--accent-primary)]">
            {stats.totalBookings}
          </p>
          <p className="text-[color:var(--text-secondary)] text-sm">
            Total Bookings
            ...
            {bookings.length > 0 ? (
              ...
              bookings
                ...
                .map(booking => (
                  ...
                  <div
                    key={booking.id}
                    className="flex justify-between items-center border-b border-[color:var(--border-primary)] pb-2 last:border-0 last:pb-0"
                  >
              ...
              <p className="text-[color:var(--text-secondary)] text-center py-4">
                No bookings yet
              </p>
                ...
                .map(pkg => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <Link
                        to={`/host/create-package?edit=${pkg.id}`}
                        className="text-[color:var(--accent-primary)] hover:text-[color:var(--accent-primary-hover)] text-xs font-medium inline-block mt-1"
                      >
                        Manage
                      </Link>

...
const MyPackagesScreen = () => {
  ...
  useEffect(() => {
      ...
      async () => {
        ...
        try {
          ...
          if (!response.ok) {
            ...
            let message =
              `Unable to load packages. Server returned ${response.status}.`;
    ...
    if (
      ...
      setError(
        'Access denied. This section is available to tour companies only.'
      );
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() =>
                        navigate(
                          `/host/create-package?edit=${pkg.id}`
                        )
                      }
